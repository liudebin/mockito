...
class PluginRegistry {
    ...
    private final MockMaker mockMaker = new PluginLoader(pluginSwitch)
            .withAlias("inline-mock", "org.mockito.internal.creation.bytebuddy.InlineByteBuddyMockMaker")
            .loadPlugin(MockMaker.class, "org.mockito.internal.creation.bytebuddy.SubclassByteBuddyMockMaker");
//            .loadPlugin(MockMaker.class, "org.mockito.internal.creation.bytebuddy.InlineByteBuddyMockMaker");
